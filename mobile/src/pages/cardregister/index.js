...
export default function CardRegister() {
  ...
  return (
    <>
      ...
      <TouchableOpacity style={styles.back} activeOpacity={0.6} onPress={() => navigateHome()}>
        ...
        <View style={styles.inputComponent}>
          ...
          <View style={styles.inputComponent}>
            ...
            <Text style={styles.textSmall}>Essa senha permite ao Flourish apenas a visualização de dados, não é possível fazer nenhuma transação em sua conta.</Text>
